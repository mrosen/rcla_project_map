...
KNOWN_ROTARIAN_EMAILS = {
    ...
    "armand boissy": "armand@lakeatitlanrotary.org", # RCLA
    "terrence wakely": "joe.wakely@gmail.com",
    "joe wakely": "joe.wakely@gmail.com",
    "duncan aitken": "duncan@lakeatitlanrotary.org",
    "michael rosen": "mrosen@lakeatitlanrotary.org",
    "shad qudsi": "shad@atitlanorganics.com",
    "clinton white": "clint@lakeatitlanrotary.org",
    "clint white": "clint@lakeatitlanrotary.org",
}

# RCLA Shepherd name expansion and emails
RCLA_SHEPHERDS = {
    "mike": ("Michael Rosen", "mrosen@lakeatitlanrotary.org"),
    "michael rosen": ("Michael Rosen", "mrosen@lakeatitlanrotary.org"),
    "joe": ("Terrence (Joe) Wakely", "joe.wakely@gmail.com"),
    "terrence wakely": ("Terrence (Joe) Wakely", "joe.wakely@gmail.com"),
    "duncan": ("Duncan Aitken", "duncan@lakeatitlanrotary.org"),
    "duncan aitken": ("Duncan Aitken", "duncan@lakeatitlanrotary.org"),
    "armand": ("Armand Boissy", "armand@lakeatitlanrotary.org"),
    "armand boissy": ("Armand Boissy", "armand@lakeatitlanrotary.org"),
    "candise": ("Candis Krummel", "candis@lakeatitlanrotary.org"),
    "candis krummel": ("Candis Krummel", "candis@lakeatitlanrotary.org"),
    "michelle": ("Michelle Fajkus", "michelle@lakeatitlanrotary.org"),
    "michelle fajkus": ("Michelle Fajkus", "michelle@lakeatitlanrotary.org"),
    "clint": ("Clinton White", "clint@lakeatitlanrotary.org"),
    "clinton white": ("Clinton White", "clint@lakeatitlanrotary.org"),
    "shad": ("Shad Qudsi", "shad@atitlanorganics.com"),
    "shad qudsi": ("Shad Qudsi", "shad@atitlanorganics.com"),
    "emilio": ("Emilio Crespo Morales", "emilio@lakeatitlanrotary.org"),
    "emilio crespo morales": ("Emilio Crespo Morales", "emilio@lakeatitlanrotary.org"),
    "dwight": ("Dwight Mara-Poage", "dwight@lakeatitlanrotary.org"),
    "dwight mara-poage": ("Dwight Mara-Poage", "dwight@lakeatitlanrotary.org"),
